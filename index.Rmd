...
Emphasis will be placed on the application of these advanced geospatial tools to natural and anthropogenic hazards, and to land use processes.
...
-   **Random Forest**: As example of supervised machine learning algorithm.
    We present both the global and the local version, and we use Random Forest to introduce interpretability & explainability in machine learning.
...
Marj's contributions to this book include the development of the conceptual framework, writing the theoretical background chapters, developing case studies, designing methodologies, and conducting data collection and analysis, software/tool development.
