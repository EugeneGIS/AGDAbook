...
## 2.2) Computer lab: GWSS

### 2.2.1) Load the libraries
...
### 2.2.2) Import the forest fire dataset
...
### 2.2.3) Forest fires spatial distribution
...
### 2.2.4) Compute the geographically whited statistics
...
## 3) Conclusions and further analyses
